...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-lightbg-border dark:border-darkbg-border bg-white/10 dark:bg-black/10 backdrop-blur-sm py-12 relative overflow-hidden">
      ...
      <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 w-80 h-80 bg-primary-500/10 dark:bg-primary-500/5 blur-[80px] rounded-full pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center border-b border-lightbg-border dark:border-darkbg-border pb-8 mb-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full border border-lightbg-border dark:border-darkbg-border bg-white/40 dark:bg-slate-900/40 flex items-center justify-center text-slate-600 dark:text-slate-300 hover:bg-primary-500 hover:text-white dark:hover:bg-primary-500 transition-all duration-300 shadow-sm"
          ...
          <div className="flex flex-col items-center md:items-end justify-center gap-3">
            ...
            <a
              ...
              className="group text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors flex items-center gap-1.5"
            >
              Back to top
